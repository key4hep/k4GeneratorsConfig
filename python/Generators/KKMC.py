...
class KKMC(GeneratorBase):
    ...
    def __init__(self, procinfo):
        super().__init__(procinfo, "KKMC", "dat")
    ...
    def fill_datacard(self):
        ...
        self.replaceOptionInGeneratorDatacard("_ewmode", self.procinfo.settings.get_ew_mode())
        self.replaceOptionInGeneratorDatacard("_isrmode", self.procinfo.get("isrmode"))
        self.replaceOptionInGeneratorDatacard("_fsrmode", self.procinfo.settings.get("fsrmode", 0))
